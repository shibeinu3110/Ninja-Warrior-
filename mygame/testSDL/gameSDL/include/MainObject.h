...
class MainObject : public BaseObject //ke thua lop base object
{
    public:
        ...
        void HandleInputAction (SDL_Event events , SDL_Renderer* screen); //xu ly du lieu bam nut
        void set_clips() ; //tạo hiệu ứng clip cho frame

        void DoPlayer (Map& map_data); //roi tu do nhan vat va di chuyen
        //truyền vào bản đồ để tìm ra va chạm
        void CheckToMap (Map& map_data); //va cham nhan vat va ban do
